...
const Register = (props) => {
  ...
  return (
    <>
      <form onSubmit={registerHandelr} style={{ width: `27%`, margin: `0 auto` }}>
        <fieldset>
          <div className="add-product__data">
            <div className="form-controls"><section className="tabs">
              <div className="tabs__headers">
                <div className="tabs__header active">Register
          </div>
                <div className="tabs__header">
                  <NavLink className="" exact to="/users/login"> Login </NavLink>
                </div>
              </div>
