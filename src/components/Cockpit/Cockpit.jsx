        ...
        <div className="header">
          ...
          <div className="header__middle container">
            ...
            <div className="header__user-options">
              <div className="dropdown">
                <div className="dropdown__header">
                  Welcome {accessToken.username()}<NavLink className="nav__link" exact to="/users/login" onClick={logout}> Logout </NavLink>
                </div>
              </div>
              <div className="dropdown__body">
                  ...
                  <li className="dropdown__item list__item">
                    <div className="item-small-1">
                      ...
                      <div className="item-small-1__image-box">
                        <span href="#" className="item-small-1__image image image-product-1" >
                        </span>
            ...
            <ul className="nav__items list list--hr">
              ...
              <li className="nav__item dropdown ">
                ...
                <div className="dropdown__body">
                  <ul className=" list">
                    <li className="list__item">
                      <NavLink to="/products" className="nav__inner-link">Product Listing</NavLink>
                    </li>
                    <li className="list__item">
                      <NavLink to="/add" className="nav__inner-link">Add Product</NavLink>
                    </li>
                  </ul>
                </div>
              </li>
